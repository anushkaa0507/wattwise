...
text-[#1e293b] shadow-sm backdrop-blur-sm"
            >
...
`}
      ...
      `}
                        ...
                        <div>
                          <div
                            className={`text-sm font-bold transition-colors duration-500 ${
                              item.on ? "text-[#1e293b]" : "text-slate-400"
                            }`}
                          >
                            {item.name}
                          </div>
                      ...
                      <div
                        ...
                        className={`w-12 h-6 rounded-full relative p-1 cursor-pointer transition-all duration-300 ${
                          item.on
          ...
          <div className="max-w-7xl mx-auto px-6 py-24 overflow-hidden">
            ...
            >
              {extendedGallery.map((item, index) => (
                <div
                  key={index}
                  className="group relative overflow-hidden rounded-2xl h-64 w-[320px] flex-shrink-0 bg-slate-900"
                >
                  <img
                    src={item.img}
                    alt={item.title}
